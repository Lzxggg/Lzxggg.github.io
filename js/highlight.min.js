...
!function (e) {
    ...
    function d(e, r, n, i) {
        ...
        function h(e) {
            C += e.cN ? m(e.cN, "", !0) : "", k = Object.create(e, {parent: {value: k}})
        }
        ...
        try {
            ...
            if (I.message && -1 !== I.message.indexOf("Illegal")) return {r: 0, value: t(r)};
            throw I
        }
    }
    ...
    var k = [], x = Object.keys, E = {}, C = {}, M = /^(no-?highlight|plain|text)$/i, B = /\blang(?:uage)?-([\w-]+)\b/i,
        L = /((^(<[^>]+>|\t|)+|(?:\n)))/gm, R = "</span>",
    ...
    return e.highlight = d, e.highlightAuto = b, e.fixMarkup = p, e.highlightBlock = f, e.configure = g, e.initHighlighting = _, e.initHighlightingOnLoad = h, e.registerLanguage = v, e.listLanguages = y, e.getLanguage = w, e.autoDetection = N, e.inherit = s, e.IR = "[a-zA-Z]\\w*", e.UIR = "[a-zA-Z_]\\w*", e.NR = "\\b\\d+(\\.\\d+)?", e.CNR = "(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)", e.BNR = "\\b(0b[01]+)", e.RSR = "!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~", e.BE = {
        ...
        return {
            ...
            c: [e.C("^\\s*[!#]", "$"), {
                ...
                starts: s
            }, {b: i + a, rB: !0, r: 0, c: [{cN: "meta", b: i, endsParent: !0, r: 0}], starts: s}, {
                cN: "attr",
                r: 0,
                b: i + t + "$"
            }]
